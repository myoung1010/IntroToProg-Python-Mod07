...
class FileProcessor:
    ...
    Myoung,3.12.2025,Incorporated code to convert stored Student object data to JSON dictionaries
    """
    @staticmethod
    def read_data_from_file(file_name: str):
        ...
        Myoung,3.12.2025,Incorporated code to convert dictionary stored data to Student object data
        ...
        try:
            ...
            for student in json_students:
                student_obj = Student(first_name = student["FirstName"],
    ...
    def write_data_to_file(file_name: str, student_data: list):
        ...
        ChangeLog: (Who, When, What)
        RRoot,1.1.2030,Created function
        Myoung,3.12.2025,Incorporated code to convert Student object data back to dictionaries
        ...
        try:
            ...
            json.dump(json_students, file, indent="")
            file.close()
